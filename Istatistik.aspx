<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="Istatistik.aspx.cs" Inherits="CvEntityProje.WebForm8" %>
...
<div class="list_of_members">
    <div class="sales">
        ...
        <div class="icon-text">
            <h3>
                <asp:Label ID="lblToplamYetenek" runat="server"></asp:Label></h3>
            <p>Toplam Yetenek</p>
        </div>
    ...
    <div class="new-users">
        ...
        <div class="icon-text">
            <h3><asp:Label ID="lblGelenMesajSayisi" runat="server"></asp:Label></h3>
            <p>Gelen Mesaj</p>
        </div>
        <div class="clearfix"></div>
    </div>
    <div class="orders">
        ...
        <div class="icon-text">
            <h3><asp:Label ID="lblOrtalamaDerecePuani" runat="server"></asp:Label></h3>
            <p>Ortalama Derece</p>
        </div>
        <div class="clearfix"></div>
    </div>
    <div class="visitors">
        ...
        <div class="icon-text">
            <h3><asp:Label ID="lblEnYuksekDerece" runat="server"></asp:Label></h3>
            <p>Yüksek Derece</p>
        </div>
        <div class="clearfix"></div>
    </div>
...
<div class="total-world">
    ...
    <div class="site-report">
        ...
        <p>Entity CV Projemizin Admin Kısmındasınız. İstatistikleri Görüntülüyorsunuz.</p>
    </div>
    <div class="clearfix"></div>
</div>
</asp:Content>
